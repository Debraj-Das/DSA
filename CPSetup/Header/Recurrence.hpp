...
template <typename T, int N, int mod = 1000000007> struct Matrix {
  int order = N;
  T m[N][N];
...
template <typename T, int order, int mod = 1000000007> class Recurrence {
protected:
...
template <typename T, int order, int mod = 1000000007> class RecurrenceNH {
protected:
