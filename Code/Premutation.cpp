...
int index(int v1[], int n, int mis)
{
    int ans = 0, i = n - 1, j, m = 0, x, y = 0;
...
void solve()
{
    ...
    int ind = index(v, n, mis);

    f(i, 0, ind) cout << ar[i] << sp;
    cout << mis << sp;
    f(i, ind, n - 1) cout << ar[i] << sp;
    cout << el;
