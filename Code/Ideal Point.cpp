  ...
  After Solving the any problems
    ...
    3. Make note ->
        a. Didied the into keys steps
           i) Sweepline algorithm
        b. Topic and level(out of 100)
           Topic - Sweepline , level - easy
        etc..
    4. What new points you discover from this problems
        a. insight
           i) number line and line segment
        b. intuition
           i) sweepline
        c. process (steps of both)
           i) see the starting and ending point of segment lines
    etc...
*/