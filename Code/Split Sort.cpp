  ...
  After Solving the any problems
    ...
    3. Make note ->
        a. Didied the into keys steps
           i) Find out the Brute solution 
           ii) See the How to optiomized it by implement it
        b. Topic and level(out of 100)
           i) Topic - Sorting and Ordering
           
    4. What new points you discover from this problems
        a. insight
           i) ordering the Element if nessary (sorting) 
        b. intuition
           i) For min find out the nessary ordering
        c. process (steps of both)
           i) nessary ordering and implementation
*/