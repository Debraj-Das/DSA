  ...
  After Solving the any problems
    ...
    3. Make note ->
        a. Didied the into keys steps
           i) if n is divided by [l, r] then it also divided by [1, r-l+1]
           ii) find the first integer which n%x != 0 then ans = (x-1)
        b. Topic and level(out of 100)
           Topic - math , level - easy
           
    4. What new points you discover from this problems
        a. insight
           i) Division of any number by any continuous of number
        b. intuition
           i) any continuous k number multiple are divisible by [1, k]
        c. process (steps of both)
           i) only continuous of division any number
