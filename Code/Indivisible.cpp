  ...
  After Solving the any problems
    ...
    3. Make note ->
        a. Didied the into keys steps
           i) Observation on math sum of series
        b. Topic and level(out of 100)
           Topic - constructive math , level - hard due to constructive nature of question
    4. What new points you discover from this problems
        a. insight
           i) sum of natural numbers
        b. intuition
           i) sum of n constructive natural number sum is divisible by n if n is odd number
        c. process (steps of both)
           i) constructive of nature
*/