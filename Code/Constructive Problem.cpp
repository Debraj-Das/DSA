...
void solve()
{
    ...
    int i, j;
    for (i = 0; i < n and a[i] != Mex + 1; i++)
        ;
    for (j = n - 1; j >= i and a[j] != Mex + 1; j--)
        ;
