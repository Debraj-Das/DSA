...
// Example for two pointer: longest subarray with given sum for non nagative
// element of array
...
Some Imp key points of this implement
   ...
   2. find the window value(winVal) for checking windows conditions and storeing
the windows value
   3. find to include and exclude the element form the windows and accordingly
